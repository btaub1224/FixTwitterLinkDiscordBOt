...
async def on_message(message):
    ...
    if any(valid_url in message.content for valid_url in valid_urls):
        ...
        new_message = "https://vxtiktok.com" + str(message.content.split(".com", 1)[1].split(" ", 1)[0])
        await message.channel.send("Fixed tiktok link, originally posted by posted by " + str(message.author) + ": " + new_message)
